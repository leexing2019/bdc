<template>
  <div class="min-h-screen bg-gray-50 flex">
    ...
    <nav class="lg:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 z-40 mobile-nav-height pb-safe">
      <div class="flex justify-around items-center h-14">
        ...
        >
          ...
          <span class="text-[10px] mt-0.5 leading-tight">{{ item.name }}</span>
        </router-link>
      </div>
